...
const EditPost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`${BACKEND_URL}/api/posts/${id}`, formData, {
        headers: {
    ...
    return (
      <div style={{ 
        ...
        <div className="text-center">
          ...
          <p className="mt-3" style={{ color: '#795548', fontSize: 18 }}>Loading post...</p>
        </div>
      </div>
    );
  }
      ...
      <Container className="py-5">
        <div className="text-center mb-5">
          <h1 className="fw-bold" style={{ 
            ...
            <span role="img" aria-label="post" style={{ fontSize: 40, verticalAlign: 'middle' }}>✏️</span> Edit Post
          </h1>
          <p className="lead" style={{ 
            ...
            Update your post to share with the community!
          </p>
        </div>
